...
function Homepage() {
    ...
    return (
        <Box display="grid" gridTemplateColumns="repeat(12, 1fr)" gridTemplateRows="1fr 2fr 3fr" gap={5} className='h'>
            ...
            <Box gridColumn="span 9">
                <Card className='h-progress'>
                    <Grid item xs={12} className='h-progress-linear'>
                        <LinearProgress variant='determinate' value={30} bar='' />
                    </Grid>
                    <Grid container className='h-progress-circular-all'>
                        ...
                        <Grid item xs={3} className='h-progress-circular-individual'>
                            <CircularProgressWithLabel value={40} size={circularProgressSize} />
                            <h3 className='h-progress-circular-individual-title'>Design</h3>
                        </Grid>
                        <Grid item xs={3} className='h-progress-circular-individual'>
                            <CircularProgressWithLabel value={0} size={circularProgressSize} />
